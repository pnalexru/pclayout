...
const updateTimer = () => {
	...
	secondsBlock.nextElementSibling.textContent = numWords(fSeconds, [
		'секунда',
		'секунды',
		'секунд',
	])
	minutesBlock.nextElementSibling.textContent = numWords(fMinutes, [
		'минута',
		'минуты',
		'минут',
	])
	hoursBlock.nextElementSibling.textContent = numWords(fHours, [
		'час',
		'часа',
		'часов',
	])
	daysBlock.nextElementSibling.textContent = numWords(fDays, [
		'день',
		'дня',
		'дней',
	])
